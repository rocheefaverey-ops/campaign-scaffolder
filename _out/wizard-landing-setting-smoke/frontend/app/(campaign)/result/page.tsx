    ...
    <div className="campaign-screen campaign-screen--hero">
      ...
      <div className="campaign-shell">
        ...
        <div className="campaign-actions" style={{ animation: 'fadeIn 0.5s 0.32s ease both' }}>
          <Button className="w-full" size="lg" onClick={() => navigate('/landing')}>
            {cta}
          </Button>
          {showPlayAgain && (
            <Button variant="secondary" className="w-full" size="lg" onClick={() => navigate('/gameplay')}>
              {retryLabel}
            </Button>
          )}
          {showLeaderboard && (
            <Button variant="ghost" className="w-full" size="lg" onClick={() => navigate('/landing')}>
              {lbLabel}
            </Button>
          )}
        </div>
