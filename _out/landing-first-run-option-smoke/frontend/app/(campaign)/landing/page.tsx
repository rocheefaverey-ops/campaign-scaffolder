...
export default function LandingPage() {
  ...
  const onboardingFirstRunOnly = getCapeBoolean(capeData, `settings.pages.${instanceId}.onboardingFirstRunOnly`, true);
  ...
  const nextAfterLanding = '/onboarding';
  const nextAfterOnboardingRaw = '/gameplay';
